...
def test_cache_key_generation():
    ...
    key2 = cache._key("TestAgent", "test_stage", "test", {}, agent_version="1.0.1")  # Different version
...
def test_cache_key_context_change():
    ...
    key1 = cache._key("TestAgent", "test_stage", "test", {"test_stage.key": "value1"}, agent_version="1.0.0")
    key2 = cache._key("TestAgent", "test_stage", "test", {"test_stage.key": "value2"}, agent_version="1.0.0")  # Different context
